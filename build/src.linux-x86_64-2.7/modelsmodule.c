 ...
 * Generation date: Fri May 27 09:25:51 2016
 * $Revision:$
 * $Date:$
...
#endif
  if (!PyArg_ParseTupleAndKeywords(capi_args,capi_keywds,\
    "O:models.models.slide_allocate",\
    capi_kwlist,&n_cel_capi))
    return NULL;
/*frompyobj*/
  /* Processing variable n_cel */
...
slide_ocurrence(n_cel,cell,storaget3,maxstot3)\n\nWrapper for ``slide_ocurrence``.\
\n\nParameters\n----------\n"
"n_cel : input int\n"
"cell : input int\n"
...
/*decl*/
  ...
  static char *capi_kwlist[] = {"n_cel","cell","storaget3","maxstot3",NULL};
...
#endif
  if (!PyArg_ParseTupleAndKeywords(capi_args,capi_keywds,\
    "OOOO:models.models.slide_ocurrence",\
    capi_kwlist,&n_cel_capi,&cell_capi,&storaget3_capi,&maxstot3_capi))
    return NULL;
/*frompyobj*/
  /* Processing variable cell */
    f2py_success = int_from_pyobj(&cell,cell_capi,"models.models.slide_ocurrence() 2nd argument (cell) can't be converted to int");
  if (f2py_success) {
  /* Processing variable storaget3 */
    f2py_success = float_from_pyobj(&storaget3,storaget3_capi,"models.models.slide_ocurrence() 3rd argument (storaget3) can't be converted to float");
  if (f2py_success) {
  /* Processing variable maxstot3 */
    f2py_success = float_from_pyobj(&maxstot3,maxstot3_capi,"models.models.slide_ocurrence() 4th argument (maxstot3) can't be converted to float");
  if (f2py_success) {
  /* Processing variable n_cel */
...
#endif
/*callfortranroutine*/
        (*f2py_func)(&n_cel,&cell,&storaget3,&maxstot3);
if (PyErr_Occurred())
  f2py_success = 0;
#ifdef F2PY_REPORT_ATEXIT
f2py_stop_call_clock();
...
/*decl*/
  ...
  int cell = 0;
  PyObject *cell_capi = Py_None;
  static char *capi_kwlist[] = {"n_cel","cell",NULL};
...
#endif
  if (!PyArg_ParseTupleAndKeywords(capi_args,capi_keywds,\
    "OO:models.models.slide_hill2gullie",\
    capi_kwlist,&n_cel_capi,&cell_capi))
    return NULL;
/*frompyobj*/
  /* Processing variable cell */
...
static void f2py_setup_models(void (*posevento)(int*,int*,void(*)(char*,int*),int*),void (*control)(int*,int*,void(*)(char*,int*),int*),void (*zmax)(int*,int*,void(*)(char*,int*),int*),char *verbose,void (*h_coef)(int*,int*,void(*)(char*,int*),int*),void (*zmin)(int*,int*,void(*)(char*,int*),int*),void (*posstra)(int*,int*,void(*)(char*,int*),int*),void (*radslope)(int*,int*,void(*)(char*,int*),int*),void (*hill_long)(int*,int*,void(*)(char*,int*),int*),void (*frictionangle)(int*,int*,void(*)(char*,int*),int*),char *sim_sediments,char *erot,void (*fluxes)(int*,int*,void(*)(char*,int*),int*),char *gullienogullie,char *show_storage,char *rute_storage,void (*max_capilar)(int*,int*,void(*)(char*,int*),int*),void (*elem_area)(int*,int*,void(*)(char*,int*),int*),void (*guarda_cond)(int*,int*,void(*)(char*,int*),int*),void (*vs)(int*,int*,void(*)(char*,int*),int*),void (*h_exp)(int*,int*,void(*)(char*,int*),int*),void (*zcrit)(int*,int*,void(*)(char*,int*),int*),void (*hill_slope)(int*,int*,void(*)(char*,int*),int*),void (*riskvector)(int*,int*,void(*)(char*,int*),int*),char *separate_fluxes,void (*voldepo)(int*,int*,void(*)(char*,int*),int*),void (*stream_width)(int*,int*,void(*)(char*,int*),int*),char *separate_rain,void (*storage_stra)(int*,int*,void(*)(char*,int*),int*),char *nrows,void (*prus)(int*,int*,void(*)(char*,int*),int*),char *dx,char *rute_speed,char *dt,void (*crus)(int*,int*,void(*)(char*,int*),int*),void (*storage_conv)(int*,int*,void(*)(char*,int*),int*),void (*drena)(int*,int*,void(*)(char*,int*),int*),char *xll,char *dep,char *dept,void (*vdc)(int*,int*,void(*)(char*,int*),int*),void (*vsc)(int*,int*,void(*)(char*,int*),int*),void (*slideocurrence)(int*,int*,void(*)(char*,int*),int*),char *ero,void (*idevento)(int*,int*,void(*)(char*,int*),int*),void (*vd)(int*,int*,void(*)(char*,int*),int*),char *dxp,void (*volero)(int*,int*,void(*)(char*,int*),int*),char *sim_slides,char *speed_type,char *diametro,void (*v_exp)(int*,int*,void(*)(char*,int*),int*),char *sed_factor,void (*parliac)(int*,int*,void(*)(char*,int*),int*),void (*max_gravita)(int*,int*,void(*)(char*,int*),int*),void (*storage)(int*,int*,void(*)(char*,int*),int*),void (*unit_type)(int*,int*,void(*)(char*,int*),int*),void (*mean_rain)(int*,int*,void(*)(char*,int*),int*),void (*krus)(int*,int*,void(*)(char*,int*),int*),char *retorno,void (*zs)(int*,int*,void(*)(char*,int*),int*),char *save_storage,char *gammaw,char *fs,void (*gammas)(int*,int*,void(*)(char*,int*),int*),char *ncols,char *rain_first_point,void (*bo)(int*,int*,void(*)(char*,int*),int*),char *wi,void (*speed_map)(int*,int*,void(*)(char*,int*),int*),char *qskr,char *save_speed,void (*stream_slope)(int*,int*,void(*)(char*,int*),int*),void (*retorned)(int*,int*,void(*)(char*,int*),int*),void (*stream_long)(int*,int*,void(*)(char*,int*),int*),char *g,void (*posconv)(int*,int*,void(*)(char*,int*),int*),void (*mean_storage)(int*,int*,void(*)(char*,int*),int*),char *nceldas,void (*cohesion)(int*,int*,void(*)(char*,int*),int*),void (*v_coef)(int*,int*,void(*)(char*,int*),int*),char *yll,char *nodata,void (*control_h)(int*,int*,void(*)(char*,int*),int*),char *shia_v1,char *read_float_basin,char *read_float_basin_ncol,char *read_int_basin,char *write_float_basin,char *write_int_basin,char *rain_read_ascii_table,char *rain_read_ascii_table_separate,char *rain_pre_mit,char *rain_mit,char *rain_idw,char *calc_speed,char *sed_allocate,char *sed_hillslope,char *sed_channel,char *slide_allocate,char *slide_ocurrence,char *slide_hill2gullie,char *basin_subbasin_map2subbasin) {
  int i_f2py=0;
  ...
  f2py_models_def[i_f2py++].func = radslope;
  ...
  f2py_models_def[i_f2py++].data = gullienogullie;
...
extern void F_FUNC(f2pyinitmodels,F2PYINITMODELS)(void (*)(void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),char*,void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),char*,char*,void (*)(int*,int*,void(*)(char*,int*),int*),char*,char*,char*,void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),char*,void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),char*,void (*)(int*,int*,void(*)(char*,int*),int*),char*,void (*)(int*,int*,void(*)(char*,int*),int*),char*,char*,char*,void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),char*,char*,char*,void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),char*,void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),char*,void (*)(int*,int*,void(*)(char*,int*),int*),char*,char*,char*,void (*)(int*,int*,void(*)(char*,int*),int*),char*,void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),char*,void (*)(int*,int*,void(*)(char*,int*),int*),char*,char*,char*,void (*)(int*,int*,void(*)(char*,int*),int*),char*,char*,void (*)(int*,int*,void(*)(char*,int*),int*),char*,void (*)(int*,int*,void(*)(char*,int*),int*),char*,char*,void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),char*,void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),char*,void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),char*,char*,void (*)(int*,int*,void(*)(char*,int*),int*),char *,char *,char *,char *,char *,char *,char *,char *,char *,char *,char *,char *,char *,char *,char *,char *,char *,char *,char *));
...
"Fortran 90/95 modules:\n""  models --- posevento,control,zmax,verbose,h_coef,zmin,posstra,radslope,hill_long,frictionangle,sim_sediments,erot,fluxes,gullienogullie,show_storage,rute_storage,max_capilar,elem_area,guarda_cond,vs,h_exp,zcrit,hill_slope,riskvector,separate_fluxes,voldepo,stream_width,separate_rain,storage_stra,nrows,prus,dx,rute_speed,dt,crus,storage_conv,drena,xll,dep,dept,vdc,vsc,slideocurrence,ero,idevento,vd,dxp,volero,sim_slides,speed_type,diametro,v_exp,sed_factor,parliac,max_gravita,storage,unit_type,mean_rain,krus,retorno,zs,save_storage,gammaw,fs,gammas,ncols,rain_first_point,bo,wi,speed_map,qskr,save_speed,stream_slope,retorned,stream_long,g,posconv,mean_storage,nceldas,cohesion,v_coef,yll,nodata,control_h,shia_v1(),read_float_basin(),read_float_basin_ncol(),read_int_basin(),write_float_basin(),write_int_basin(),rain_read_ascii_table(),rain_read_ascii_table_separate(),rain_pre_mit(),rain_mit(),rain_idw(),calc_speed(),sed_allocate(),sed_hillslope(),sed_channel(),slide_allocate(),slide_ocurrence(),slide_hill2gullie(),basin_subbasin_map2subbasin()"".");
