 ...
 * Generation date: Tue Oct 11 14:32:19 2016
 * $Revision:$
 * $Date:$
...
q,qsed,qseparated,hum,balance,speed,stoout,qsep_byrain = shia_v1(ruta_bin,ruta_hdr,calib,n_cel,n_cont,n_conth,n_reg,[ruta_storage,ruta_speed,ruta_binconv,ruta_binstra,ruta_hdrconv,ruta_hdrstra])\n\nWrapper for ``shia_v1``.\
\n\nParameters\n----------\n"
...
static PyObject *f2py_rout_models_models_shia_v1(const PyObject *capi_self,
                           ...
                           void (*f2py_func)(string,string,float*,int*,int*,int*,int*,float*,float*,float*,float*,float*,float*,float*,string,string,string,string,string,string,float*,size_t,size_t,size_t,size_t,size_t,size_t,size_t,size_t)) {
...
#endif
/*callfortranroutine*/
        (*f2py_func)(ruta_bin,ruta_hdr,calib,&n_cel,&n_cont,&n_conth,&n_reg,q,qsed,qseparated,hum,balance,speed,stoout,ruta_storage,ruta_speed,ruta_binconv,ruta_binstra,ruta_hdrconv,ruta_hdrstra,qsep_byrain,slen(ruta_bin),slen(ruta_hdr),slen(ruta_storage),slen(ruta_speed),slen(ruta_binconv),slen(ruta_binstra),slen(ruta_hdrconv),slen(ruta_hdrstra));
if (PyErr_Occurred())
  f2py_success = 0;
#ifdef F2PY_REPORT_ATEXIT
...
/*end of pyobjfrom*/
    ...
    capi_buildvalue = Py_BuildValue("NNNNNNNN",capi_q_tmp,capi_qsed_tmp,capi_qseparated_tmp,capi_hum_tmp,capi_balance_tmp,capi_speed_tmp,capi_stoout_tmp,capi_qsep_byrain_tmp);
/*closepyobjfrom*/
...
extern void F_FUNC(f2pyinitmodels,F2PYINITMODELS)(void (*)(void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),char*,char*,void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),char*,char*,char*,void (*)(int*,int*,void(*)(char*,int*),int*),char*,char*,void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),char*,void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),char*,void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),char*,char*,char*,char*,void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),char*,char*,void (*)(int*,int*,void(*)(char*,int*),int*),char*,void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),char*,void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),char*,void (*)(int*,int*,void(*)(char*,int*),int*),char*,char*,char*,void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),char*,void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),char*,char*,char*,char*,char*,char*,void (*)(int*,int*,void(*)(char*,int*),int*),char*,void (*)(int*,int*,void(*)(char*,int*),int*),char*,void (*)(int*,int*,void(*)(char*,int*),int*),char*,void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),char*,void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),char*,char*,void (*)(int*,int*,void(*)(char*,int*),int*),char*,char*,void (*)(int*,int*,void(*)(char*,int*),int*),char *,char *,char *,char *,char *,char *,char *,char *,char *,char *,char *,char *,char *,char *,char *,char *,char *,char *,char *));
...
"Fortran 90/95 modules:\n""  models --- posevento,idevento,sl_fs,verbose,max_capilar,posstra,sl_bo,prus,hill_long,dxp,save_speed,erot,fluxes,show_storage,rute_storage,h_coef,elem_area,guarda_cond,sl_slideocurrence,vs,show_speed,sl_slidencelltime,retorned,separate_fluxes,voldepo,unit_type,sl_zmax,sl_zmin,sl_frictionangle,h_exp,nrows,dx,rute_speed,dt,crus,storage_conv,drena,xll,dep,krus,dept,vdc,vsc,sl_slideacumulate,ero,sl_riskvector,sl_zcrit,control,vd,mean_speed,sl_gammas,sl_gammaw,volero,sim_slides,speed_type,diametro,v_exp,parliac,show_mean_speed,max_gravita,storage,storage_stra,mean_rain,sl_cohesion,separate_rain,retorno,save_storage,sl_gullienogullie,ncols,rain_first_point,hill_slope,wi,sl_radslope,qskr,sl_zs,sim_sediments,speed_map,stream_slope,stream_width,stream_long,g,posconv,mean_storage,nceldas,sed_factor,v_coef,yll,nodata,control_h,shia_v1(),read_float_basin(),read_float_basin_ncol(),read_int_basin(),write_float_basin(),write_int_basin(),rain_read_ascii_table(),rain_read_ascii_table_separate(),rain_pre_mit(),rain_mit(),rain_idw(),calc_speed(),sed_allocate(),sed_hillslope(),sed_channel(),slide_allocate(),slide_ocurrence(),slide_hill2gullie(),basin_subbasin_map2subbasin()"".");
