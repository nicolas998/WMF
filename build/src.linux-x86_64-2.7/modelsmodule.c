 ...
 * Generation date: Thu Oct 13 13:43:21 2016
 * $Revision:$
 * $Date:$
...
q,qsed,qseparated,hum,balance,speed,areacontrol,stoout,qsep_byrain = shia_v1(ruta_bin,ruta_hdr,calib,n_cel,n_cont,n_conth,n_reg,[ruta_storage,ruta_speed,ruta_binconv,ruta_binstra,ruta_hdrconv,ruta_hdrstra])\n\nWrapper for ``shia_v1``.\
\n\nParameters\n----------\n"
...
static PyObject *f2py_rout_models_models_shia_v1(const PyObject *capi_self,
                           ...
                           void (*f2py_func)(string,string,float*,int*,int*,int*,int*,float*,float*,float*,float*,float*,float*,float*,float*,string,string,string,string,string,string,float*,size_t,size_t,size_t,size_t,size_t,size_t,size_t,size_t)) {
...
/*decl*/
  ...
  static char *capi_kwlist[] = {"ruta_bin","ruta_hdr","calib","n_cel","n_cont","n_conth","n_reg","ruta_storage","ruta_speed","ruta_binconv","ruta_binstra","ruta_hdrconv","ruta_hdrstra",NULL};
...
f2py_start_clock();
  ...
  if (!PyArg_ParseTupleAndKeywords(capi_args,capi_keywds,\
    "OOOOOOO|OOOOOO:models.models.shia_v1",\
    capi_kwlist,&ruta_bin_capi,&ruta_hdr_capi,&calib_capi,&n_cel_capi,&n_cont_capi,&n_conth_capi,&n_reg_capi,&ruta_storage_capi,&ruta_speed_capi,&ruta_binconv_capi,&ruta_binstra_capi,&ruta_hdrconv_capi,&ruta_hdrstra_capi))
    return NULL;
/*frompyobj*/
  ...
  f2py_success = string_from_pyobj(&ruta_binstra,&slen(ruta_binstra),"",ruta_binstra_capi,"string_from_pyobj failed in converting 4th keyword `ruta_binstra' of models.models.shia_v1 to C string");
  if (f2py_success) {
  /* Processing variable ruta_hdrstra */
  slen(ruta_hdrstra) = 500;
  f2py_success = string_from_pyobj(&ruta_hdrstra,&slen(ruta_hdrstra),"",ruta_hdrstra_capi,"string_from_pyobj failed in converting 6th keyword `ruta_hdrstra' of models.models.shia_v1 to C string");
  if (f2py_success) {
  ...
  f2py_success = string_from_pyobj(&ruta_hdrconv,&slen(ruta_hdrconv),"",ruta_hdrconv_capi,"string_from_pyobj failed in converting 5th keyword `ruta_hdrconv' of models.models.shia_v1 to C string");
  if (f2py_success) {
  ...
  f2py_success = string_from_pyobj(&ruta_binconv,&slen(ruta_binconv),"",ruta_binconv_capi,"string_from_pyobj failed in converting 3rd keyword `ruta_binconv' of models.models.shia_v1 to C string");
  if (f2py_success) {
  ...
  slen(ruta_speed) = 500;
  f2py_success = string_from_pyobj(&ruta_speed,&slen(ruta_speed),"",ruta_speed_capi,"string_from_pyobj failed in converting 2nd keyword `ruta_speed' of models.models.shia_v1 to C string");
  if (f2py_success) {
...
#endif
/*callfortranroutine*/
        (*f2py_func)(ruta_bin,ruta_hdr,calib,&n_cel,&n_cont,&n_conth,&n_reg,q,qsed,qseparated,hum,balance,speed,areacontrol,stoout,ruta_storage,ruta_speed,ruta_binconv,ruta_binstra,ruta_hdrconv,ruta_hdrstra,qsep_byrain,slen(ruta_bin),slen(ruta_hdr),slen(ruta_storage),slen(ruta_speed),slen(ruta_binconv),slen(ruta_binstra),slen(ruta_hdrconv),slen(ruta_hdrstra));
if (PyErr_Occurred())
  f2py_success = 0;
#ifdef F2PY_REPORT_ATEXIT
...
/*end of pyobjfrom*/
    ...
    capi_buildvalue = Py_BuildValue("NNNNNNNNN",capi_q_tmp,capi_qsed_tmp,capi_qseparated_tmp,capi_hum_tmp,capi_balance_tmp,capi_speed_tmp,capi_areacontrol_tmp,capi_stoout_tmp,capi_qsep_byrain_tmp);
/*closepyobjfrom*/
...
static void f2py_setup_models(void (*posevento)(int*,int*,void(*)(char*,int*),int*),void (*idevento)(int*,int*,void(*)(char*,int*),int*),char *sl_fs,char *verbose,void (*max_capilar)(int*,int*,void(*)(char*,int*),int*),void (*posstra)(int*,int*,void(*)(char*,int*),int*),void (*sl_bo)(int*,int*,void(*)(char*,int*),int*),void (*prus)(int*,int*,void(*)(char*,int*),int*),void (*hill_long)(int*,int*,void(*)(char*,int*),int*),char *dxp,char *save_speed,char *erot,void (*fluxes)(int*,int*,void(*)(char*,int*),int*),char *show_storage,char *rute_storage,void (*h_coef)(int*,int*,void(*)(char*,int*),int*),void (*elem_area)(int*,int*,void(*)(char*,int*),int*),void (*guarda_cond)(int*,int*,void(*)(char*,int*),int*),void (*sl_slideocurrence)(int*,int*,void(*)(char*,int*),int*),void (*vs)(int*,int*,void(*)(char*,int*),int*),char *show_speed,void (*sl_slidencelltime)(int*,int*,void(*)(char*,int*),int*),void (*retorned)(int*,int*,void(*)(char*,int*),int*),char *separate_fluxes,void (*voldepo)(int*,int*,void(*)(char*,int*),int*),void (*unit_type)(int*,int*,void(*)(char*,int*),int*),void (*sl_zmax)(int*,int*,void(*)(char*,int*),int*),void (*sl_zmin)(int*,int*,void(*)(char*,int*),int*),void (*sl_frictionangle)(int*,int*,void(*)(char*,int*),int*),void (*h_exp)(int*,int*,void(*)(char*,int*),int*),char *nrows,char *dx,char *rute_speed,char *dt,void (*crus)(int*,int*,void(*)(char*,int*),int*),void (*storage_conv)(int*,int*,void(*)(char*,int*),int*),void (*drena)(int*,int*,void(*)(char*,int*),int*),char *xll,char *dep,void (*krus)(int*,int*,void(*)(char*,int*),int*),char *dept,void (*vdc)(int*,int*,void(*)(char*,int*),int*),void (*vsc)(int*,int*,void(*)(char*,int*),int*),char *show_area,void (*sl_slideacumulate)(int*,int*,void(*)(char*,int*),int*),char *ero,void (*sl_riskvector)(int*,int*,void(*)(char*,int*),int*),void (*sl_zcrit)(int*,int*,void(*)(char*,int*),int*),void (*control)(int*,int*,void(*)(char*,int*),int*),void (*vd)(int*,int*,void(*)(char*,int*),int*),void (*mean_speed)(int*,int*,void(*)(char*,int*),int*),void (*sl_gammas)(int*,int*,void(*)(char*,int*),int*),char *sl_gammaw,void (*volero)(int*,int*,void(*)(char*,int*),int*),char *sim_slides,char *speed_type,char *diametro,void (*v_exp)(int*,int*,void(*)(char*,int*),int*),void (*parliac)(int*,int*,void(*)(char*,int*),int*),char *show_mean_speed,void (*max_gravita)(int*,int*,void(*)(char*,int*),int*),void (*storage)(int*,int*,void(*)(char*,int*),int*),void (*storage_stra)(int*,int*,void(*)(char*,int*),int*),void (*mean_rain)(int*,int*,void(*)(char*,int*),int*),void (*sl_cohesion)(int*,int*,void(*)(char*,int*),int*),char *separate_rain,char *retorno,char *save_storage,char *sl_gullienogullie,char *ncols,char *rain_first_point,void (*hill_slope)(int*,int*,void(*)(char*,int*),int*),char *wi,void (*sl_radslope)(int*,int*,void(*)(char*,int*),int*),char *qskr,void (*sl_zs)(int*,int*,void(*)(char*,int*),int*),char *sim_sediments,void (*speed_map)(int*,int*,void(*)(char*,int*),int*),void (*stream_slope)(int*,int*,void(*)(char*,int*),int*),void (*stream_width)(int*,int*,void(*)(char*,int*),int*),void (*stream_long)(int*,int*,void(*)(char*,int*),int*),char *g,void (*posconv)(int*,int*,void(*)(char*,int*),int*),void (*mean_storage)(int*,int*,void(*)(char*,int*),int*),char *nceldas,char *sed_factor,void (*v_coef)(int*,int*,void(*)(char*,int*),int*),char *yll,char *nodata,void (*control_h)(int*,int*,void(*)(char*,int*),int*),char *shia_v1,char *read_float_basin,char *read_float_basin_ncol,char *read_int_basin,char *write_float_basin,char *write_int_basin,char *rain_read_ascii_table,char *rain_read_ascii_table_separate,char *rain_pre_mit,char *rain_mit,char *rain_idw,char *calc_speed,char *sed_allocate,char *sed_hillslope,char *sed_channel,char *slide_allocate,char *slide_ocurrence,char *slide_hill2gullie,char *basin_subbasin_map2subbasin) {
  int i_f2py=0;
...
extern void F_FUNC(f2pyinitmodels,F2PYINITMODELS)(void (*)(void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),char*,char*,void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),char*,char*,char*,void (*)(int*,int*,void(*)(char*,int*),int*),char*,char*,void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),char*,void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),char*,void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),char*,char*,char*,char*,void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),char*,char*,void (*)(int*,int*,void(*)(char*,int*),int*),char*,void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),char*,void (*)(int*,int*,void(*)(char*,int*),int*),char*,void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),char*,void (*)(int*,int*,void(*)(char*,int*),int*),char*,char*,char*,void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),char*,void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),char*,char*,char*,char*,char*,char*,void (*)(int*,int*,void(*)(char*,int*),int*),char*,void (*)(int*,int*,void(*)(char*,int*),int*),char*,void (*)(int*,int*,void(*)(char*,int*),int*),char*,void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),char*,void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),char*,char*,void (*)(int*,int*,void(*)(char*,int*),int*),char*,char*,void (*)(int*,int*,void(*)(char*,int*),int*),char *,char *,char *,char *,char *,char *,char *,char *,char *,char *,char *,char *,char *,char *,char *,char *,char *,char *,char *));
...
"Fortran 90/95 modules:\n""  models --- posevento,idevento,sl_fs,verbose,max_capilar,posstra,sl_bo,prus,hill_long,dxp,save_speed,erot,fluxes,show_storage,rute_storage,h_coef,elem_area,guarda_cond,sl_slideocurrence,vs,show_speed,sl_slidencelltime,retorned,separate_fluxes,voldepo,unit_type,sl_zmax,sl_zmin,sl_frictionangle,h_exp,nrows,dx,rute_speed,dt,crus,storage_conv,drena,xll,dep,krus,dept,vdc,vsc,show_area,sl_slideacumulate,ero,sl_riskvector,sl_zcrit,control,vd,mean_speed,sl_gammas,sl_gammaw,volero,sim_slides,speed_type,diametro,v_exp,parliac,show_mean_speed,max_gravita,storage,storage_stra,mean_rain,sl_cohesion,separate_rain,retorno,save_storage,sl_gullienogullie,ncols,rain_first_point,hill_slope,wi,sl_radslope,qskr,sl_zs,sim_sediments,speed_map,stream_slope,stream_width,stream_long,g,posconv,mean_storage,nceldas,sed_factor,v_coef,yll,nodata,control_h,shia_v1(),read_float_basin(),read_float_basin_ncol(),read_int_basin(),write_float_basin(),write_int_basin(),rain_read_ascii_table(),rain_read_ascii_table_separate(),rain_pre_mit(),rain_mit(),rain_idw(),calc_speed(),sed_allocate(),sed_hillslope(),sed_channel(),slide_allocate(),slide_ocurrence(),slide_hill2gullie(),basin_subbasin_map2subbasin()"".");
