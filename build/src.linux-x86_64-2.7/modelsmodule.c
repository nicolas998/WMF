 ...
 * Generation date: Fri Feb 19 08:17:11 2016
 * $Revision:$
 * $Date:$
...
q,qsed,hum,balance,stoout = shia_v1(ruta,calib,n_cel,n_cont,n_conth,n_reg)\n\nWrapper for ``shia_v1``.\
\n\nParameters\n----------\n"
...
static PyObject *f2py_rout_models_models_shia_v1(const PyObject *capi_self,
                           ...
                           void (*f2py_func)(string,float*,int*,int*,int*,int*,float*,float*,float*,float*,float*,size_t)) {
...
/*decl*/
  ...
  static char *capi_kwlist[] = {"ruta","calib","n_cel","n_cont","n_conth","n_reg",NULL};
...
f2py_start_clock();
  ...
  if (!PyArg_ParseTupleAndKeywords(capi_args,capi_keywds,\
    "OOOOOO:models.models.shia_v1",\
    capi_kwlist,&ruta_capi,&calib_capi,&n_cel_capi,&n_cont_capi,&n_conth_capi,&n_reg_capi))
    return NULL;
/*frompyobj*/
  ...
  slen(ruta) = 500;
  f2py_success = string_from_pyobj(&ruta,&slen(ruta),"",ruta_capi,"string_from_pyobj failed in converting 1st argument `ruta' of models.models.shia_v1 to C string");
  if (f2py_success) {
  ...
  if (capi_calib_tmp == NULL) {
    if (!PyErr_Occurred())
      PyErr_SetString(models_error,"failed in converting 2nd argument `calib' of models.models.shia_v1 to C/Fortran array" );
  } else {
    calib = (float *)(capi_calib_tmp->data);

  /* Processing variable n_cel */
    f2py_success = int_from_pyobj(&n_cel,n_cel_capi,"models.models.shia_v1() 3rd argument (n_cel) can't be converted to int");
  if (f2py_success) {
  ...
  if (capi_balance_tmp == NULL) {
    ...
    balance = (float *)(capi_balance_tmp->data);
...
#endif
/*callfortranroutine*/
        (*f2py_func)(ruta,calib,&n_cel,&n_cont,&n_conth,&n_reg,q,qsed,hum,balance,stoout,slen(ruta));
if (PyErr_Occurred())
  f2py_success = 0;
#ifdef F2PY_REPORT_ATEXIT
...
/*end of pyobjfrom*/
    ...
    capi_buildvalue = Py_BuildValue("NNNNN",capi_q_tmp,capi_qsed_tmp,capi_hum_tmp,capi_balance_tmp,capi_stoout_tmp);
/*closepyobjfrom*/
...
/*frompyobj*/
  ...
  if (capi_meanrain_tmp == NULL) {
    ...
    meanrain = (float *)(capi_meanrain_tmp->data);
...
meanrain = rain_idw(xy_basin,coord,rain,pp,ruta,[nceldas,ncoord,nreg])\n\nWrapper for ``rain_idw``.\
\n\nParameters\n----------\n"
"xy_basin : input rank-2 array('f') with bounds (2,nceldas)\n"
"coord : input rank-2 array('f') with bounds (2,ncoord)\n"
"rain : input rank-2 array('f') with bounds (ncoord,nreg)\n"
...
static PyObject *f2py_rout_models_models_rain_idw(const PyObject *capi_self,
                           PyObject *capi_args,
                           PyObject *capi_keywds,
                           void (*f2py_func)(float*,float*,float*,float*,int*,int*,int*,string,float*,size_t)) {
  PyObject * volatile capi_buildvalue = NULL;
  volatile int f2py_success = 1;
/*decl*/
  ...
  PyArrayObject *capi_meanrain_tmp = NULL;
  int capi_meanrain_intent = 0;
  static char *capi_kwlist[] = {"xy_basin","coord","rain","pp","ruta","nceldas","ncoord","nreg",NULL};
...
#endif
  if (!PyArg_ParseTupleAndKeywords(capi_args,capi_keywds,\
    "OOOOO|OOO:models.models.rain_idw",\
    capi_kwlist,&xy_basin_capi,&coord_capi,&rain_capi,&pp_capi,&ruta_capi,&nceldas_capi,&ncoord_capi,&nreg_capi))
    return NULL;
/*frompyobj*/
  ...
  /* Processing variable ruta */
  slen(ruta) = 255;
  f2py_success = string_from_pyobj(&ruta,&slen(ruta),"",ruta_capi,"string_from_pyobj failed in converting 5th argument `ruta' of models.models.rain_idw to C string");
  if (f2py_success) {
  /* Processing variable xy_basin */
  xy_basin_Dims[0]=2;
  capi_xy_basin_intent |= F2PY_INTENT_IN;
...
#endif
/*callfortranroutine*/
        (*f2py_func)(xy_basin,coord,rain,&pp,&nceldas,&ncoord,&nreg,ruta,meanrain,slen(ruta));
if (PyErr_Occurred())
  f2py_success = 0;
#ifdef F2PY_REPORT_ATEXIT
f2py_stop_call_clock();
...
static void f2py_setup_models(void (*zmax)(int*,int*,void(*)(char*,int*),int*),void (*h_coef)(int*,int*,void(*)(char*,int*),int*),void (*zmin)(int*,int*,void(*)(char*,int*),int*),void (*prus)(int*,int*,void(*)(char*,int*),int*),void (*hill_long)(int*,int*,void(*)(char*,int*),int*),void (*frictionangle)(int*,int*,void(*)(char*,int*),int*),char *sim_sediments,char *erot,char *rute_storage,void (*max_capilar)(int*,int*,void(*)(char*,int*),int*),void (*elem_area)(int*,int*,void(*)(char*,int*),int*),void (*guarda_cond)(int*,int*,void(*)(char*,int*),int*),void (*vs)(int*,int*,void(*)(char*,int*),int*),void (*h_exp)(int*,int*,void(*)(char*,int*),int*),void (*zcrit)(int*,int*,void(*)(char*,int*),int*),void (*hill_slope)(int*,int*,void(*)(char*,int*),int*),void (*riskvector)(int*,int*,void(*)(char*,int*),int*),void (*voldepo)(int*,int*,void(*)(char*,int*),int*),char *nrows,char *dx,char *rute_speed,char *dt,void (*crus)(int*,int*,void(*)(char*,int*),int*),void (*drena)(int*,int*,void(*)(char*,int*),int*),char *xll,char *dep,char *dept,void (*vdc)(int*,int*,void(*)(char*,int*),int*),void (*vsc)(int*,int*,void(*)(char*,int*),int*),void (*slideocurrence)(int*,int*,void(*)(char*,int*),int*),char *ero,void (*control)(int*,int*,void(*)(char*,int*),int*),void (*vd)(int*,int*,void(*)(char*,int*),int*),char *dxp,void (*volero)(int*,int*,void(*)(char*,int*),int*),char *sim_slides,char *speed_type,char *diametro,void (*v_exp)(int*,int*,void(*)(char*,int*),int*),char *sed_factor,void (*parliac)(int*,int*,void(*)(char*,int*),int*),void (*max_gravita)(int*,int*,void(*)(char*,int*),int*),void (*storage)(int*,int*,void(*)(char*,int*),int*),void (*unit_type)(int*,int*,void(*)(char*,int*),int*),void (*mean_rain)(int*,int*,void(*)(char*,int*),int*),void (*krus)(int*,int*,void(*)(char*,int*),int*),void (*zs)(int*,int*,void(*)(char*,int*),int*),char *save_storage,char *gammaw,char *fs,void (*gammas)(int*,int*,void(*)(char*,int*),int*),char *ncols,char *rain_first_point,void (*bo)(int*,int*,void(*)(char*,int*),int*),char *wi,void (*speed_map)(int*,int*,void(*)(char*,int*),int*),char *qskr,char *save_speed,void (*stream_slope)(int*,int*,void(*)(char*,int*),int*),void (*stream_width)(int*,int*,void(*)(char*,int*),int*),void (*stream_long)(int*,int*,void(*)(char*,int*),int*),char *g,char *nceldas,void (*cohesion)(int*,int*,void(*)(char*,int*),int*),void (*v_coef)(int*,int*,void(*)(char*,int*),int*),char *yll,char *nodata,void (*control_h)(int*,int*,void(*)(char*,int*),int*),char *shia_v1,char *read_float_basin,char *write_float_basin,char *rain_pre_mit,char *rain_mit,char *rain_idw,char *calc_speed,char *sed_allocate,char *sed_hillslope,char *sed_channel,char *slide_allocate,char *slide_ocurrence,char *slide_hill2gullie) {
  int i_f2py=0;
...
extern void F_FUNC(f2pyinitmodels,F2PYINITMODELS)(void (*)(void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),char*,char*,char*,void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),char*,char*,char*,char*,void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),char*,char*,char*,void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),char*,void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),char*,void (*)(int*,int*,void(*)(char*,int*),int*),char*,char*,char*,void (*)(int*,int*,void(*)(char*,int*),int*),char*,void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),char*,char*,char*,void (*)(int*,int*,void(*)(char*,int*),int*),char*,char*,void (*)(int*,int*,void(*)(char*,int*),int*),char*,void (*)(int*,int*,void(*)(char*,int*),int*),char*,char*,void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),char*,char*,void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),char*,char*,void (*)(int*,int*,void(*)(char*,int*),int*),char *,char *,char *,char *,char *,char *,char *,char *,char *,char *,char *,char *,char *));
...
"Fortran 90/95 modules:\n""  models --- zmax,h_coef,zmin,prus,hill_long,frictionangle,sim_sediments,erot,rute_storage,max_capilar,elem_area,guarda_cond,vs,h_exp,zcrit,hill_slope,riskvector,voldepo,nrows,dx,rute_speed,dt,crus,drena,xll,dep,dept,vdc,vsc,slideocurrence,ero,control,vd,dxp,volero,sim_slides,speed_type,diametro,v_exp,sed_factor,parliac,max_gravita,storage,unit_type,mean_rain,krus,zs,save_storage,gammaw,fs,gammas,ncols,rain_first_point,bo,wi,speed_map,qskr,save_speed,stream_slope,stream_width,stream_long,g,nceldas,cohesion,v_coef,yll,nodata,control_h,shia_v1(),read_float_basin(),write_float_basin(),rain_pre_mit(),rain_mit(),rain_idw(),calc_speed(),sed_allocate(),sed_hillslope(),sed_channel(),slide_allocate(),slide_ocurrence(),slide_hill2gullie()"".");
