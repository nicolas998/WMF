 ...
 * Generation date: Wed Feb 10 08:24:29 2016
 * $Revision:$
 * $Date:$
...
rain_idw(xy_basin,coord,rain,pp,ruta,[nceldas,ncoord,nreg])\n\nWrapper for ``rain_idw``.\
\n\nParameters\n----------\n"
"xy_basin : input rank-2 array('f') with bounds (2,nceldas)\n"
"coord : input rank-2 array('f') with bounds (2,ncoord)\n"
"rain : input rank-2 array('f') with bounds (ncoord,nreg)\n"
...
static PyObject *f2py_rout_models_models_rain_idw(const PyObject *capi_self,
                           PyObject *capi_args,
                           PyObject *capi_keywds,
                           void (*f2py_func)(float*,float*,float*,float*,int*,int*,int*,string,size_t)) {
  PyObject * volatile capi_buildvalue = NULL;
  volatile int f2py_success = 1;
/*decl*/
...
#endif
/*callfortranroutine*/
        (*f2py_func)(xy_basin,coord,rain,&pp,&nceldas,&ncoord,&nreg,ruta,slen(ruta));
if (PyErr_Occurred())
  f2py_success = 0;
#ifdef F2PY_REPORT_ATEXIT
f2py_stop_call_clock();
