 ...
 * Generation date: Tue May 10 09:09:48 2016
 * $Revision:$
 * $Date:$
...
q,qsed,qseparated,hum,balance,stoout = shia_v1(ruta_bin,ruta_hdr,calib,n_cel,n_cont,n_conth,n_reg,[ruta_storage])\n\nWrapper for ``shia_v1``.\
\n\nParameters\n----------\n"
...
static PyObject *f2py_rout_models_models_shia_v1(const PyObject *capi_self,
                           ...
                           void (*f2py_func)(string,string,float*,int*,int*,int*,int*,float*,float*,float*,float*,float*,float*,string,size_t,size_t,size_t)) {
...
/*decl*/
  ...
  static char *capi_kwlist[] = {"ruta_bin","ruta_hdr","calib","n_cel","n_cont","n_conth","n_reg","ruta_storage",NULL};
...
f2py_start_clock();
  ...
  if (!PyArg_ParseTupleAndKeywords(capi_args,capi_keywds,\
    "OOOOOOO|O:models.models.shia_v1",\
    capi_kwlist,&ruta_bin_capi,&ruta_hdr_capi,&calib_capi,&n_cel_capi,&n_cont_capi,&n_conth_capi,&n_reg_capi,&ruta_storage_capi))
    return NULL;
/*frompyobj*/
...
#endif
/*callfortranroutine*/
        (*f2py_func)(ruta_bin,ruta_hdr,calib,&n_cel,&n_cont,&n_conth,&n_reg,q,qsed,qseparated,hum,balance,stoout,ruta_storage,slen(ruta_bin),slen(ruta_hdr),slen(ruta_storage));
if (PyErr_Occurred())
  f2py_success = 0;
#ifdef F2PY_REPORT_ATEXIT
...
/*end of pyobjfrom*/
    ...
    capi_buildvalue = Py_BuildValue("NNNNNN",capi_q_tmp,capi_qsed_tmp,capi_qseparated_tmp,capi_hum_tmp,capi_balance_tmp,capi_stoout_tmp);
/*closepyobjfrom*/
...
#endif
  if (!PyArg_ParseTupleAndKeywords(capi_args,capi_keywds,\
    "OOO:models.models.slide_ocurrence",\
    capi_kwlist,&cell_capi,&storaget3_capi,&maxstot3_capi))
    return NULL;
/*frompyobj*/
  /* Processing variable cell */
    f2py_success = int_from_pyobj(&cell,cell_capi,"models.models.slide_ocurrence() 1st argument (cell) can't be converted to int");
  if (f2py_success) {
  /* Processing variable storaget3 */
    f2py_success = float_from_pyobj(&storaget3,storaget3_capi,"models.models.slide_ocurrence() 2nd argument (storaget3) can't be converted to float");
  if (f2py_success) {
  /* Processing variable maxstot3 */
    f2py_success = float_from_pyobj(&maxstot3,maxstot3_capi,"models.models.slide_ocurrence() 3rd argument (maxstot3) can't be converted to float");
  if (f2py_success) {
/*end of frompyobj*/
#ifdef F2PY_REPORT_ATEXIT
f2py_start_call_clock();
...
#endif
  if (!PyArg_ParseTupleAndKeywords(capi_args,capi_keywds,\
    "O:models.models.slide_hill2gullie",\
    capi_kwlist,&cell_capi))
    return NULL;
/*frompyobj*/
  /* Processing variable cell */
    f2py_success = int_from_pyobj(&cell,cell_capi,"models.models.slide_hill2gullie() 1st argument (cell) can't be converted to int");
  if (f2py_success) {
/*end of frompyobj*/
#ifdef F2PY_REPORT_ATEXIT
f2py_start_call_clock();
...
static void f2py_setup_models(void (*posevento)(int*,int*,void(*)(char*,int*),int*),void (*control)(int*,int*,void(*)(char*,int*),int*),void (*zmax)(int*,int*,void(*)(char*,int*),int*),char *verbose,void (*h_coef)(int*,int*,void(*)(char*,int*),int*),void (*zmin)(int*,int*,void(*)(char*,int*),int*),void (*prus)(int*,int*,void(*)(char*,int*),int*),void (*hill_long)(int*,int*,void(*)(char*,int*),int*),void (*frictionangle)(int*,int*,void(*)(char*,int*),int*),char *sim_sediments,char *erot,void (*fluxes)(int*,int*,void(*)(char*,int*),int*),char *gullienogullie,char *rute_storage,void (*max_capilar)(int*,int*,void(*)(char*,int*),int*),void (*elem_area)(int*,int*,void(*)(char*,int*),int*),void (*guarda_cond)(int*,int*,void(*)(char*,int*),int*),void (*vs)(int*,int*,void(*)(char*,int*),int*),void (*h_exp)(int*,int*,void(*)(char*,int*),int*),void (*retorned)(int*,int*,void(*)(char*,int*),int*),void (*hill_slope)(int*,int*,void(*)(char*,int*),int*),void (*riskvector)(int*,int*,void(*)(char*,int*),int*),char *separate_fluxes,void (*voldepo)(int*,int*,void(*)(char*,int*),int*),char *nrows,char *dx,char *rute_speed,char *dt,void (*crus)(int*,int*,void(*)(char*,int*),int*),void (*drena)(int*,int*,void(*)(char*,int*),int*),char *xll,char *dep,char *dept,void (*vdc)(int*,int*,void(*)(char*,int*),int*),void (*vsc)(int*,int*,void(*)(char*,int*),int*),void (*slideocurrence)(int*,int*,void(*)(char*,int*),int*),char *ero,void (*idevento)(int*,int*,void(*)(char*,int*),int*),void (*vd)(int*,int*,void(*)(char*,int*),int*),char *dxp,void (*volero)(int*,int*,void(*)(char*,int*),int*),char *sim_slides,char *speed_type,char *diametro,void (*v_exp)(int*,int*,void(*)(char*,int*),int*),char *sed_factor,void (*parliac)(int*,int*,void(*)(char*,int*),int*),void (*max_gravita)(int*,int*,void(*)(char*,int*),int*),void (*storage)(int*,int*,void(*)(char*,int*),int*),void (*unit_type)(int*,int*,void(*)(char*,int*),int*),void (*mean_rain)(int*,int*,void(*)(char*,int*),int*),void (*krus)(int*,int*,void(*)(char*,int*),int*),char *retorno,void (*zs)(int*,int*,void(*)(char*,int*),int*),char *save_storage,char *gammaw,char *fs,void (*gammas)(int*,int*,void(*)(char*,int*),int*),char *ncols,void (*zcrit)(int*,int*,void(*)(char*,int*),int*),char *rain_first_point,void (*bo)(int*,int*,void(*)(char*,int*),int*),char *wi,void (*speed_map)(int*,int*,void(*)(char*,int*),int*),char *qskr,char *save_speed,void (*stream_slope)(int*,int*,void(*)(char*,int*),int*),void (*stream_width)(int*,int*,void(*)(char*,int*),int*),void (*stream_long)(int*,int*,void(*)(char*,int*),int*),char *g,char *nceldas,void (*cohesion)(int*,int*,void(*)(char*,int*),int*),void (*v_coef)(int*,int*,void(*)(char*,int*),int*),char *yll,char *nodata,void (*control_h)(int*,int*,void(*)(char*,int*),int*),char *shia_v1,char *read_float_basin,char *read_int_basin,char *write_float_basin,char *write_int_basin,char *rain_read_ascii_table,char *rain_pre_mit,char *rain_mit,char *rain_idw,char *calc_speed,char *sed_allocate,char *sed_hillslope,char *sed_channel,char *slide_allocate,char *slide_ocurrence,char *slide_hill2gullie,char *basin_subbasin_map2subbasin) {
  int i_f2py=0;
...
extern void F_FUNC(f2pyinitmodels,F2PYINITMODELS)(void (*)(void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),char*,void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),char*,char*,void (*)(int*,int*,void(*)(char*,int*),int*),char*,char*,void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),char*,void (*)(int*,int*,void(*)(char*,int*),int*),char*,char*,char*,char*,void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),char*,char*,char*,void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),char*,void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),char*,void (*)(int*,int*,void(*)(char*,int*),int*),char*,char*,char*,void (*)(int*,int*,void(*)(char*,int*),int*),char*,void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),char*,void (*)(int*,int*,void(*)(char*,int*),int*),char*,char*,char*,void (*)(int*,int*,void(*)(char*,int*),int*),char*,void (*)(int*,int*,void(*)(char*,int*),int*),char*,void (*)(int*,int*,void(*)(char*,int*),int*),char*,void (*)(int*,int*,void(*)(char*,int*),int*),char*,char*,void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),char*,char*,void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),char*,char*,void (*)(int*,int*,void(*)(char*,int*),int*),char *,char *,char *,char *,char *,char *,char *,char *,char *,char *,char *,char *,char *,char *,char *,char *,char *));
...
"Fortran 90/95 modules:\n""  models --- posevento,control,zmax,verbose,h_coef,zmin,prus,hill_long,frictionangle,sim_sediments,erot,fluxes,gullienogullie,rute_storage,max_capilar,elem_area,guarda_cond,vs,h_exp,retorned,hill_slope,riskvector,separate_fluxes,voldepo,nrows,dx,rute_speed,dt,crus,drena,xll,dep,dept,vdc,vsc,slideocurrence,ero,idevento,vd,dxp,volero,sim_slides,speed_type,diametro,v_exp,sed_factor,parliac,max_gravita,storage,unit_type,mean_rain,krus,retorno,zs,save_storage,gammaw,fs,gammas,ncols,zcrit,rain_first_point,bo,wi,speed_map,qskr,save_speed,stream_slope,stream_width,stream_long,g,nceldas,cohesion,v_coef,yll,nodata,control_h,shia_v1(),read_float_basin(),read_int_basin(),write_float_basin(),write_int_basin(),rain_read_ascii_table(),rain_pre_mit(),rain_mit(),rain_idw(),calc_speed(),sed_allocate(),sed_hillslope(),sed_channel(),slide_allocate(),slide_ocurrence(),slide_hill2gullie(),basin_subbasin_map2subbasin()"".");
