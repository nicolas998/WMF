...
q,qsed,qseparated,hum,st1,st3,balance,speed,areacontrol,stoout,qsep_byrain = shia_v1(ruta_bin,ruta_hdr,calib,n_cont,n_conth,n_reg,[stoin,hspeedin,n_cel,ruta_storage,ruta_speed,ruta_binconv,ruta_binstra,ruta_hdrconv,ruta_hdrstra,ruta_retorno])\n\nWrapper for ``shia_v1``.\
\n\nParameters\n----------\n"
...
static PyObject *f2py_rout_models_models_shia_v1(const PyObject *capi_self,
                           ...
                           void (*f2py_func)(string,string,float*,float*,float*,int*,int*,int*,int*,float*,float*,float*,float*,float*,float*,float*,float*,float*,float*,string,string,string,string,string,string,float*,string,size_t,size_t,size_t,size_t,size_t,size_t,size_t,size_t,size_t)) {
...
/*decl*/
  ...
  static char *capi_kwlist[] = {"ruta_bin","ruta_hdr","calib","n_cont","n_conth","n_reg","stoin","hspeedin","n_cel","ruta_storage","ruta_speed","ruta_binconv","ruta_binstra","ruta_hdrconv","ruta_hdrstra","ruta_retorno",NULL};
...
f2py_start_clock();
  ...
  if (!PyArg_ParseTupleAndKeywords(capi_args,capi_keywds,\
    "OOOOOO|OOOOOOOOOO:models.models.shia_v1",\
    capi_kwlist,&ruta_bin_capi,&ruta_hdr_capi,&calib_capi,&n_cont_capi,&n_conth_capi,&n_reg_capi,&stoin_capi,&hspeedin_capi,&n_cel_capi,&ruta_storage_capi,&ruta_speed_capi,&ruta_binconv_capi,&ruta_binstra_capi,&ruta_hdrconv_capi,&ruta_hdrstra_capi,&ruta_retorno_capi))
    return NULL;
/*frompyobj*/
  ...
  f2py_success = string_from_pyobj(&ruta_binstra,&slen(ruta_binstra),"",ruta_binstra_capi,"string_from_pyobj failed in converting 7th keyword `ruta_binstra' of models.models.shia_v1 to C string");
  if (f2py_success) {
  /* Processing variable ruta_hdrstra */
  slen(ruta_hdrstra) = 500;
  f2py_success = string_from_pyobj(&ruta_hdrstra,&slen(ruta_hdrstra),"",ruta_hdrstra_capi,"string_from_pyobj failed in converting 9th keyword `ruta_hdrstra' of models.models.shia_v1 to C string");
  if (f2py_success) {
  ...
  f2py_success = string_from_pyobj(&ruta_hdrconv,&slen(ruta_hdrconv),"",ruta_hdrconv_capi,"string_from_pyobj failed in converting 8th keyword `ruta_hdrconv' of models.models.shia_v1 to C string");
  if (f2py_success) {
  /* Processing variable ruta_retorno */
  slen(ruta_retorno) = 500;
  f2py_success = string_from_pyobj(&ruta_retorno,&slen(ruta_retorno),"",ruta_retorno_capi,"string_from_pyobj failed in converting 10th keyword `ruta_retorno' of models.models.shia_v1 to C string");
  if (f2py_success) {
  ...
  stoin_Dims[0]=5;
  capi_stoin_intent |= F2PY_OPTIONAL|F2PY_INTENT_IN;
  ...
  f2py_success = string_from_pyobj(&ruta_binconv,&slen(ruta_binconv),"",ruta_binconv_capi,"string_from_pyobj failed in converting 6th keyword `ruta_binconv' of models.models.shia_v1 to C string");
  if (f2py_success) {
  ...
  capi_speed_intent |= F2PY_INTENT_HIDE|F2PY_INTENT_OUT;
  ...
  capi_qsed_intent |= F2PY_INTENT_HIDE|F2PY_INTENT_OUT;
  ...
  capi_qseparated_intent |= F2PY_INTENT_HIDE|F2PY_INTENT_OUT;
  ...
  capi_st1_intent |= F2PY_INTENT_HIDE|F2PY_INTENT_OUT;
  ...
  capi_st3_intent |= F2PY_INTENT_HIDE|F2PY_INTENT_OUT;
  ...
  capi_qsep_byrain_intent |= F2PY_INTENT_HIDE|F2PY_INTENT_OUT;
  ...
  capi_areacontrol_intent |= F2PY_INTENT_HIDE|F2PY_INTENT_OUT;
  ...
  capi_hum_intent |= F2PY_INTENT_HIDE|F2PY_INTENT_OUT;
  ...
  capi_stoout_intent |= F2PY_INTENT_HIDE|F2PY_INTENT_OUT;
  ...
  capi_hspeedin_intent |= F2PY_OPTIONAL|F2PY_INTENT_IN;
  ...
  capi_balance_intent |= F2PY_INTENT_HIDE|F2PY_INTENT_OUT;
...
#endif
/*callfortranroutine*/
        (*f2py_func)(ruta_bin,ruta_hdr,calib,stoin,hspeedin,&n_cel,&n_cont,&n_conth,&n_reg,q,qsed,qseparated,hum,st1,st3,balance,speed,areacontrol,stoout,ruta_storage,ruta_speed,ruta_binconv,ruta_binstra,ruta_hdrconv,ruta_hdrstra,qsep_byrain,ruta_retorno,slen(ruta_bin),slen(ruta_hdr),slen(ruta_storage),slen(ruta_speed),slen(ruta_binconv),slen(ruta_binstra),slen(ruta_hdrconv),slen(ruta_hdrstra),slen(ruta_retorno));
if (PyErr_Occurred())
  f2py_success = 0;
#ifdef F2PY_REPORT_ATEXIT
...
/*frompyobj*/
  ...
  capi_tin_perte_intent |= F2PY_INTENT_HIDE|F2PY_INTENT_OUT;
...
/*frompyobj*/
  ...
  capi_meanrain_intent |= F2PY_INTENT_HIDE|F2PY_INTENT_OUT;
  ...
  posids_Dims[0]=nreg;
  capi_posids_intent |= F2PY_INTENT_HIDE|F2PY_INTENT_OUT;
...
/*frompyobj*/
  ...
  volsal_Dims[0]=3;
  capi_volsal_intent |= F2PY_INTENT_HIDE|F2PY_INTENT_OUT;
...
static void f2py_setup_models(char *sl_fs,char *save_retorno,void (*posstra)(int*,int*,void(*)(char*,int*),int*),void (*hill_long)(int*,int*,void(*)(char*,int*),int*),char *flood_max_iter,char *erot,char *show_storage,char *rute_storage,void (*h_coef)(int*,int*,void(*)(char*,int*),int*),void (*guarda_cond)(int*,int*,void(*)(char*,int*),int*),void (*sl_slideocurrence)(int*,int*,void(*)(char*,int*),int*),void (*vs)(int*,int*,void(*)(char*,int*),int*),char *show_speed,void (*flood_d50)(int*,int*,void(*)(char*,int*),int*),void (*retorned)(int*,int*,void(*)(char*,int*),int*),char *flood_sec_tam,char *separate_fluxes,void (*flood_cr)(int*,int*,void(*)(char*,int*),int*),void (*flood_ufr)(int*,int*,void(*)(char*,int*),int*),void (*flood_flood)(int*,int*,void(*)(char*,int*),int*),char *nrows,char *dx,char *rute_speed,void (*mean_retorno)(int*,int*,void(*)(char*,int*),int*),char *dt,void (*crus)(int*,int*,void(*)(char*,int*),int*),char *xll,char *flood_diff,char *storage_constant,void (*flood_profundidad)(int*,int*,void(*)(char*,int*),int*),void (*vdc)(int*,int*,void(*)(char*,int*),int*),char *show_area,void (*sl_riskvector)(int*,int*,void(*)(char*,int*),int*),void (*sl_gammas)(int*,int*,void(*)(char*,int*),int*),char *sl_gammaw,void (*volero)(int*,int*,void(*)(char*,int*),int*),char *sim_slides,char *speed_type,char *diametro,char *ncols,char *show_mean_speed,void (*max_gravita)(int*,int*,void(*)(char*,int*),int*),void (*flood_sec_cells)(int*,int*,void(*)(char*,int*),int*),void (*flood_hand)(int*,int*,void(*)(char*,int*),int*),void (*storage_stra)(int*,int*,void(*)(char*,int*),int*),void (*mean_rain)(int*,int*,void(*)(char*,int*),int*),void (*flood_qsed)(int*,int*,void(*)(char*,int*),int*),char *flood_step,char *sl_gullienogullie,void (*flood_eval)(int*,int*,void(*)(char*,int*),int*),char *calc_niter,char *rain_first_point,void (*hill_slope)(int*,int*,void(*)(char*,int*),int*),char *sim_floods,char *wi,char *qskr,void (*stream_slope)(int*,int*,void(*)(char*,int*),int*),void (*stream_width)(int*,int*,void(*)(char*,int*),int*),void (*stream_long)(int*,int*,void(*)(char*,int*),int*),char *g,void (*mean_storage)(int*,int*,void(*)(char*,int*),int*),char *show_mean_retorno,char *yll,char *nodata,void (*control_h)(int*,int*,void(*)(char*,int*),int*),void (*posevento)(int*,int*,void(*)(char*,int*),int*),void (*idevento)(int*,int*,void(*)(char*,int*),int*),char *verbose,void (*max_capilar)(int*,int*,void(*)(char*,int*),int*),void (*sl_bo)(int*,int*,void(*)(char*,int*),int*),void (*prus)(int*,int*,void(*)(char*,int*),int*),void (*h_exp)(int*,int*,void(*)(char*,int*),int*),void (*acum_rain)(int*,int*,void(*)(char*,int*),int*),char *save_speed,void (*flood_slope)(int*,int*,void(*)(char*,int*),int*),void (*fluxes)(int*,int*,void(*)(char*,int*),int*),void (*mean_speed)(int*,int*,void(*)(char*,int*),int*),void (*elem_area)(int*,int*,void(*)(char*,int*),int*),void (*sl_slidencelltime)(int*,int*,void(*)(char*,int*),int*),void (*voldepo)(int*,int*,void(*)(char*,int*),int*),void (*evpserie)(int*,int*,void(*)(char*,int*),int*),void (*sl_zmax)(int*,int*,void(*)(char*,int*),int*),char *separate_rain,void (*sl_frictionangle)(int*,int*,void(*)(char*,int*),int*),void (*sl_radslope)(int*,int*,void(*)(char*,int*),int*),void (*storage_conv)(int*,int*,void(*)(char*,int*),int*),void (*drena)(int*,int*,void(*)(char*,int*),int*),char *dep,void (*krus)(int*,int*,void(*)(char*,int*),int*),char *dept,void (*vsc)(int*,int*,void(*)(char*,int*),int*),void (*flood_sections)(int*,int*,void(*)(char*,int*),int*),void (*sl_slideacumulate)(int*,int*,void(*)(char*,int*),int*),char *flood_dw,char *ero,void (*sl_zcrit)(int*,int*,void(*)(char*,int*),int*),void (*control)(int*,int*,void(*)(char*,int*),int*),void (*vd)(int*,int*,void(*)(char*,int*),int*),char *flood_dsed,void (*flood_aquien)(int*,int*,void(*)(char*,int*),int*),char *dxp,void (*flood_loc_hand)(int*,int*,void(*)(char*,int*),int*),char *flood_area,void (*v_exp)(int*,int*,void(*)(char*,int*),int*),void (*parliac)(int*,int*,void(*)(char*,int*),int*),void (*flood_speed)(int*,int*,void(*)(char*,int*),int*),void (*storage)(int*,int*,void(*)(char*,int*),int*),void (*unit_type)(int*,int*,void(*)(char*,int*),int*),void (*sl_cohesion)(int*,int*,void(*)(char*,int*),int*),void (*sl_zmin)(int*,int*,void(*)(char*,int*),int*),char *retorno,char *save_storage,char *flood_av,void (*speed_map)(int*,int*,void(*)(char*,int*),int*),char *flood_rdf,char *flood_hmax,char *flood_umbral,void (*sl_zs)(int*,int*,void(*)(char*,int*),int*),char *sim_sediments,char *qlin_sed,void (*flood_h)(int*,int*,void(*)(char*,int*),int*),void (*posconv)(int*,int*,void(*)(char*,int*),int*),char *nceldas,char *sed_factor,void (*v_coef)(int*,int*,void(*)(char*,int*),int*),void (*flood_w)(int*,int*,void(*)(char*,int*),int*),char *flood_cmax,void (*flood_q)(int*,int*,void(*)(char*,int*),int*),char *shia_v1,char *read_float_basin,char *read_float_basin_ncol,char *read_int_basin,char *write_float_basin,char *write_int_basin,char *rain_read_ascii_table,char *rain_read_ascii_table_separate,char *rain_pre_mit,char *rain_mit,char *rain_idw,char *calc_speed,char *sed_allocate,char *sed_hillslope,char *sed_channel,char *slide_allocate,char *slide_ocurrence,char *slide_hill2gullie,char *flood_allocate,char *flood_params,char *flood_find_hdiff,char *flood_debris_flow,char *flood_debris_flow2,char *basin_subbasin_map2subbasin,char *qsortc,char *partition) {
  int i_f2py=0;
...
extern void F_FUNC(f2pyinitmodels,F2PYINITMODELS)(void (*)(char*,char*,void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),char*,char*,char*,char*,void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),char*,void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),char*,char*,void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),char*,char*,char*,void (*)(int*,int*,void(*)(char*,int*),int*),char*,void (*)(int*,int*,void(*)(char*,int*),int*),char*,char*,char*,void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),char*,void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),char*,void (*)(int*,int*,void(*)(char*,int*),int*),char*,char*,char*,char*,char*,void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),char*,char*,void (*)(int*,int*,void(*)(char*,int*),int*),char*,char*,void (*)(int*,int*,void(*)(char*,int*),int*),char*,char*,char*,void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),char*,void (*)(int*,int*,void(*)(char*,int*),int*),char*,char*,char*,void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),char*,void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),char*,void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),char*,void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),char*,void (*)(int*,int*,void(*)(char*,int*),int*),char*,void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),char*,char*,void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),char*,void (*)(int*,int*,void(*)(char*,int*),int*),char*,void (*)(int*,int*,void(*)(char*,int*),int*),char*,void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),char*,char*,char*,void (*)(int*,int*,void(*)(char*,int*),int*),char*,char*,char*,void (*)(int*,int*,void(*)(char*,int*),int*),char*,char*,void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),char*,char*,void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),char*,void (*)(int*,int*,void(*)(char*,int*),int*),char *,char *,char *,char *,char *,char *,char *,char *,char *,char *,char *,char *,char *,char *,char *,char *,char *,char *,char *,char *,char *,char *,char *,char *,char *,char *));
...
"Fortran 90/95 modules:\n""  models --- sl_fs,save_retorno,posstra,hill_long,flood_max_iter,erot,show_storage,rute_storage,h_coef,guarda_cond,sl_slideocurrence,vs,show_speed,flood_d50,retorned,flood_sec_tam,separate_fluxes,flood_cr,flood_ufr,flood_flood,nrows,dx,rute_speed,mean_retorno,dt,crus,xll,flood_diff,storage_constant,flood_profundidad,vdc,show_area,sl_riskvector,sl_gammas,sl_gammaw,volero,sim_slides,speed_type,diametro,ncols,show_mean_speed,max_gravita,flood_sec_cells,flood_hand,storage_stra,mean_rain,flood_qsed,flood_step,sl_gullienogullie,flood_eval,calc_niter,rain_first_point,hill_slope,sim_floods,wi,qskr,stream_slope,stream_width,stream_long,g,mean_storage,show_mean_retorno,yll,nodata,control_h,posevento,idevento,verbose,max_capilar,sl_bo,prus,h_exp,acum_rain,save_speed,flood_slope,fluxes,mean_speed,elem_area,sl_slidencelltime,voldepo,evpserie,sl_zmax,separate_rain,sl_frictionangle,sl_radslope,storage_conv,drena,dep,krus,dept,vsc,flood_sections,sl_slideacumulate,flood_dw,ero,sl_zcrit,control,vd,flood_dsed,flood_aquien,dxp,flood_loc_hand,flood_area,v_exp,parliac,flood_speed,storage,unit_type,sl_cohesion,sl_zmin,retorno,save_storage,flood_av,speed_map,flood_rdf,flood_hmax,flood_umbral,sl_zs,sim_sediments,qlin_sed,flood_h,posconv,nceldas,sed_factor,v_coef,flood_w,flood_cmax,flood_q,shia_v1(),read_float_basin(),read_float_basin_ncol(),read_int_basin(),write_float_basin(),write_int_basin(),rain_read_ascii_table(),rain_read_ascii_table_separate(),rain_pre_mit(),rain_mit(),rain_idw(),calc_speed(),sed_allocate(),sed_hillslope(),sed_channel(),slide_allocate(),slide_ocurrence(),slide_hill2gullie(),flood_allocate(),flood_params(),flood_find_hdiff(),flood_debris_flow(),flood_debris_flow2(),basin_subbasin_map2subbasin(),qsortc(),partition()"".");
