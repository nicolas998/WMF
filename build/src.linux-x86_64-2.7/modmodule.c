 ...
 * Generation date: Wed Jan 13 09:02:07 2016
 * $Revision:$
 * $Date:$
...
static PyObject *mod_error;
static PyObject *mod_module;
...
#define PRINTPYOBJERR(obj)\
  fprintf(stderr,"mod.error is related to ");\
...
#define CHECKSCALAR(check,tcheck,name,show,var)\
  if (!(check)) {\
    ...
    PyErr_SetString(mod_error,errstring);\
    /*goto capi_fail;*/\
  } else 
...
/********************************** shia_v1 **********************************/
static char doc_f2py_rout_mod_models_shia_v1[] = "\
...
/*  */
static PyObject *f2py_rout_mod_models_shia_v1(const PyObject *capi_self,
                           PyObject *capi_args,
...
f2py_start_clock();
  ...
  if (!PyArg_ParseTupleAndKeywords(capi_args,capi_keywds,\
    "OOOOO:mod.models.shia_v1",\
    capi_kwlist,&calib_capi,&n_cel_capi,&n_cont_capi,&n_conth_capi,&n_reg_capi))
    return NULL;
/*frompyobj*/
  /* Processing variable n_conth */
    f2py_success = int_from_pyobj(&n_conth,n_conth_capi,"mod.models.shia_v1() 4th argument (n_conth) can't be converted to int");
  if (f2py_success) {
  /* Processing variable n_cont */
    f2py_success = int_from_pyobj(&n_cont,n_cont_capi,"mod.models.shia_v1() 3rd argument (n_cont) can't be converted to int");
  if (f2py_success) {
  ...
  if (capi_calib_tmp == NULL) {
    if (!PyErr_Occurred())
      PyErr_SetString(mod_error,"failed in converting 1st argument `calib' of mod.models.shia_v1 to C/Fortran array" );
  } else {
    calib = (float *)(capi_calib_tmp->data);

  /* Processing variable n_cel */
    f2py_success = int_from_pyobj(&n_cel,n_cel_capi,"mod.models.shia_v1() 2nd argument (n_cel) can't be converted to int");
  if (f2py_success) {
  /* Processing variable n_reg */
    f2py_success = int_from_pyobj(&n_reg,n_reg_capi,"mod.models.shia_v1() 5th argument (n_reg) can't be converted to int");
  if (f2py_success) {
  ...
  if (capi_hum_tmp == NULL) {
    if (!PyErr_Occurred())
      PyErr_SetString(mod_error,"failed in converting hidden `hum' of mod.models.shia_v1 to C/Fortran array" );
  } else {
  ...
  if (capi_stoout_tmp == NULL) {
    if (!PyErr_Occurred())
      PyErr_SetString(mod_error,"failed in converting hidden `stoout' of mod.models.shia_v1 to C/Fortran array" );
  } else {
  ...
  if (capi_qsed_tmp == NULL) {
    if (!PyErr_Occurred())
      PyErr_SetString(mod_error,"failed in converting hidden `qsed' of mod.models.shia_v1 to C/Fortran array" );
  } else {
  ...
  if (capi_q_tmp == NULL) {
    if (!PyErr_Occurred())
      PyErr_SetString(mod_error,"failed in converting hidden `q' of mod.models.shia_v1 to C/Fortran array" );
  } else {
...
/****************************** read_float_basin ******************************/
static char doc_f2py_rout_mod_models_read_float_basin[] = "\
...
"res : int";
/*  */
static PyObject *f2py_rout_mod_models_read_float_basin(const PyObject *capi_self,
                           PyObject *capi_args,
                           PyObject *capi_keywds,
...
#endif
  if (!PyArg_ParseTupleAndKeywords(capi_args,capi_keywds,\
    "OOO:mod.models.read_float_basin",\
    capi_kwlist,&ruta_capi,&record_capi,&n_cel_capi))
    return NULL;
/*frompyobj*/
  /* Processing variable record */
    f2py_success = int_from_pyobj(&record,record_capi,"mod.models.read_float_basin() 2nd argument (record) can't be converted to int");
  if (f2py_success) {
  /* Processing variable n_cel */
    f2py_success = int_from_pyobj(&n_cel,n_cel_capi,"mod.models.read_float_basin() 3rd argument (n_cel) can't be converted to int");
  if (f2py_success) {
  /* Processing variable res */
  /* Processing variable ruta */
  slen(ruta) = 500;
  f2py_success = string_from_pyobj(&ruta,&slen(ruta),"",ruta_capi,"string_from_pyobj failed in converting 1st argument `ruta' of mod.models.read_float_basin to C string");
  if (f2py_success) {
  ...
  if (capi_vect_tmp == NULL) {
    if (!PyErr_Occurred())
      PyErr_SetString(mod_error,"failed in converting hidden `vect' of mod.models.read_float_basin to C/Fortran array" );
  } else {
...
/***************************** write_float_basin *****************************/
static char doc_f2py_rout_mod_models_write_float_basin[] = "\
...
/*  */
static PyObject *f2py_rout_mod_models_write_float_basin(const PyObject *capi_self,
                           PyObject *capi_args,
                           PyObject *capi_keywds,
...
#endif
  if (!PyArg_ParseTupleAndKeywords(capi_args,capi_keywds,\
    "OOO|OO:mod.models.write_float_basin",\
    capi_kwlist,&ruta_capi,&vect_capi,&record_capi,&n_cel_capi,&n_col_capi))
    return NULL;
/*frompyobj*/
  /* Processing variable record */
    f2py_success = int_from_pyobj(&record,record_capi,"mod.models.write_float_basin() 3rd argument (record) can't be converted to int");
  if (f2py_success) {
  /* Processing variable ruta */
  slen(ruta) = 255;
  f2py_success = string_from_pyobj(&ruta,&slen(ruta),"",ruta_capi,"string_from_pyobj failed in converting 1st argument `ruta' of mod.models.write_float_basin to C string");
  if (f2py_success) {
  /* Processing variable vect */
  ;
  ...
  if (capi_vect_tmp == NULL) {
    if (!PyErr_Occurred())
      PyErr_SetString(mod_error,"failed in converting 2nd argument `vect' of mod.models.write_float_basin to C/Fortran array" );
  } else {
    vect = (float *)(capi_vect_tmp->data);

  /* Processing variable n_col */
  if (n_col_capi == Py_None) n_col = shape(vect,0); else
    f2py_success = int_from_pyobj(&n_col,n_col_capi,"mod.models.write_float_basin() 2nd keyword (n_col) can't be converted to int");
  if (f2py_success) {
  ...
  if (n_cel_capi == Py_None) n_cel = shape(vect,1); else
    f2py_success = int_from_pyobj(&n_cel,n_cel_capi,"mod.models.write_float_basin() 1st keyword (n_cel) can't be converted to int");
  if (f2py_success) {
...
/******************************** rain_pre_mit ********************************/
static char doc_f2py_rout_mod_models_rain_pre_mit[] = "\
...
/*  */
static PyObject *f2py_rout_mod_models_rain_pre_mit(const PyObject *capi_self,
                           PyObject *capi_args,
                           PyObject *capi_keywds,
...
#endif
  if (!PyArg_ParseTupleAndKeywords(capi_args,capi_keywds,\
    "OOO|OOO:mod.models.rain_pre_mit",\
...
/*frompyobj*/
  ...
  if (capi_xy_basin_tmp == NULL) {
    if (!PyErr_Occurred())
      PyErr_SetString(mod_error,"failed in converting 1st argument `xy_basin' of mod.models.rain_pre_mit to C/Fortran array" );
  } else {
    xy_basin = (float *)(capi_xy_basin_tmp->data);
  ...
  if (capi_coord_tmp == NULL) {
    if (!PyErr_Occurred())
      PyErr_SetString(mod_error,"failed in converting 3rd argument `coord' of mod.models.rain_pre_mit to C/Fortran array" );
  } else {
    coord = (float *)(capi_coord_tmp->data);
  ...
  if (capi_tin_tmp == NULL) {
    if (!PyErr_Occurred())
      PyErr_SetString(mod_error,"failed in converting 2nd argument `tin' of mod.models.rain_pre_mit to C/Fortran array" );
  } else {
    tin = (int *)(capi_tin_tmp->data);

  /* Processing variable ncoord */
  if (ncoord_capi == Py_None) ncoord = shape(coord,1); else
    f2py_success = int_from_pyobj(&ncoord,ncoord_capi,"mod.models.rain_pre_mit() 3rd keyword (ncoord) can't be converted to int");
  if (f2py_success) {
  ...
  if (nceldas_capi == Py_None) nceldas = shape(xy_basin,1); else
    f2py_success = int_from_pyobj(&nceldas,nceldas_capi,"mod.models.rain_pre_mit() 1st keyword (nceldas) can't be converted to int");
  if (f2py_success) {
  ...
  if (capi_tin_perte_tmp == NULL) {
    if (!PyErr_Occurred())
      PyErr_SetString(mod_error,"failed in converting hidden `tin_perte' of mod.models.rain_pre_mit to C/Fortran array" );
  } else {
    tin_perte = (int *)(capi_tin_perte_tmp->data);

  /* Processing variable ntin */
  if (ntin_capi == Py_None) ntin = shape(tin,1); else
    f2py_success = int_from_pyobj(&ntin,ntin_capi,"mod.models.rain_pre_mit() 2nd keyword (ntin) can't be converted to int");
  if (f2py_success) {
...
/********************************** rain_mit **********************************/
static char doc_f2py_rout_mod_models_rain_mit[] = "\
rain_mit(xy_basin,coord,rain,tin,tin_perte,ruta,[nceldas,ncoord,ntin,nreg])\n\nWrapper for ``rain_mit``.\
\n\nParameters\n----------\n"
"xy_basin : input rank-2 array('f') with bounds (2,nceldas)\n"
"coord : input rank-2 array('f') with bounds (2,ncoord)\n"
...
/*  */
static PyObject *f2py_rout_mod_models_rain_mit(const PyObject *capi_self,
                           PyObject *capi_args,
                           PyObject *capi_keywds,
                           void (*f2py_func)(float*,float*,float*,int*,int*,int*,int*,int*,int*,string,size_t)) {
  PyObject * volatile capi_buildvalue = NULL;
  volatile int f2py_success = 1;
/*decl*/
...
#endif
  if (!PyArg_ParseTupleAndKeywords(capi_args,capi_keywds,\
    "OOOOOO|OOOO:mod.models.rain_mit",\
...
/*frompyobj*/
  ...
  if (capi_xy_basin_tmp == NULL) {
    if (!PyErr_Occurred())
      PyErr_SetString(mod_error,"failed in converting 1st argument `xy_basin' of mod.models.rain_mit to C/Fortran array" );
  } else {
    xy_basin = (float *)(capi_xy_basin_tmp->data);

  /* Processing variable ruta */
  slen(ruta) = 255;
  f2py_success = string_from_pyobj(&ruta,&slen(ruta),"",ruta_capi,"string_from_pyobj failed in converting 6th argument `ruta' of mod.models.rain_mit to C string");
  if (f2py_success) {
  /* Processing variable tin */
  tin_Dims[0]=3;
  capi_tin_intent |= F2PY_INTENT_IN;
  ...
  if (capi_tin_tmp == NULL) {
    if (!PyErr_Occurred())
      PyErr_SetString(mod_error,"failed in converting 4th argument `tin' of mod.models.rain_mit to C/Fortran array" );
  } else {
    tin = (int *)(capi_tin_tmp->data);
  ...
  if (capi_coord_tmp == NULL) {
    if (!PyErr_Occurred())
      PyErr_SetString(mod_error,"failed in converting 2nd argument `coord' of mod.models.rain_mit to C/Fortran array" );
  } else {
    coord = (float *)(capi_coord_tmp->data);

  /* Processing variable ncoord */
  if (ncoord_capi == Py_None) ncoord = shape(coord,1); else
    f2py_success = int_from_pyobj(&ncoord,ncoord_capi,"mod.models.rain_mit() 2nd keyword (ncoord) can't be converted to int");
  if (f2py_success) {
  ...
  if (capi_rain_tmp == NULL) {
    if (!PyErr_Occurred())
      PyErr_SetString(mod_error,"failed in converting 3rd argument `rain' of mod.models.rain_mit to C/Fortran array" );
  } else {
    rain = (float *)(capi_rain_tmp->data);

  /* Processing variable ntin */
  if (ntin_capi == Py_None) ntin = shape(tin,1); else
    f2py_success = int_from_pyobj(&ntin,ntin_capi,"mod.models.rain_mit() 3rd keyword (ntin) can't be converted to int");
  if (f2py_success) {
  CHECKSCALAR(shape(tin,1)==ntin,"shape(tin,1)==ntin","3rd keyword ntin","rain_mit:ntin=%d",ntin) {
  /* Processing variable nceldas */
  if (nceldas_capi == Py_None) nceldas = shape(xy_basin,1); else
    f2py_success = int_from_pyobj(&nceldas,nceldas_capi,"mod.models.rain_mit() 1st keyword (nceldas) can't be converted to int");
  if (f2py_success) {
  ...
  if (capi_tin_perte_tmp == NULL) {
    if (!PyErr_Occurred())
      PyErr_SetString(mod_error,"failed in converting 5th argument `tin_perte' of mod.models.rain_mit to C/Fortran array" );
  } else {
    tin_perte = (int *)(capi_tin_perte_tmp->data);

  /* Processing variable nreg */
  if (nreg_capi == Py_None) nreg = shape(rain,1); else
    f2py_success = int_from_pyobj(&nreg,nreg_capi,"mod.models.rain_mit() 4th keyword (nreg) can't be converted to int");
  if (f2py_success) {
...
#endif
/*callfortranroutine*/
        (*f2py_func)(xy_basin,coord,rain,tin,tin_perte,&nceldas,&ncoord,&ntin,&nreg,ruta,slen(ruta));
if (PyErr_Occurred())
  f2py_success = 0;
#ifdef F2PY_REPORT_ATEXIT
f2py_stop_call_clock();
...
/********************************* calc_speed *********************************/
static char doc_f2py_rout_mod_models_calc_speed[] = "\
...
"area : float";
/*  */
static PyObject *f2py_rout_mod_models_calc_speed(const PyObject *capi_self,
                           PyObject *capi_args,
                           PyObject *capi_keywds,
...
#endif
  if (!PyArg_ParseTupleAndKeywords(capi_args,capi_keywds,\
    "OOOOO:mod.models.calc_speed",\
    capi_kwlist,&sm_capi,&coef_capi,&expo_capi,&elem_long_capi,&speed_capi))
    return NULL;
/*frompyobj*/
  /* Processing variable area */
  /* Processing variable elem_long */
    f2py_success = float_from_pyobj(&elem_long,elem_long_capi,"mod.models.calc_speed() 4th argument (elem_long) can't be converted to float");
  if (f2py_success) {
  /* Processing variable coef */
    f2py_success = float_from_pyobj(&coef,coef_capi,"mod.models.calc_speed() 2nd argument (coef) can't be converted to float");
  if (f2py_success) {
  /* Processing variable expo */
    f2py_success = float_from_pyobj(&expo,expo_capi,"mod.models.calc_speed() 3rd argument (expo) can't be converted to float");
  if (f2py_success) {
  /* Processing variable sm */
    f2py_success = float_from_pyobj(&sm,sm_capi,"mod.models.calc_speed() 1st argument (sm) can't be converted to float");
  if (f2py_success) {
  /* Processing variable speed */
    f2py_success = float_from_pyobj(&speed,speed_capi,"mod.models.calc_speed() 5th argument (speed) can't be converted to float");
  if (f2py_success) {
/*end of frompyobj*/
#ifdef F2PY_REPORT_ATEXIT
f2py_start_call_clock();
...
/******************************** sed_allocate ********************************/
static char doc_f2py_rout_mod_models_sed_allocate[] = "\
sed_allocate()\n\nWrapper for ``sed_allocate``.\
\n";
/*  */
static PyObject *f2py_rout_mod_models_sed_allocate(const PyObject *capi_self,
                           PyObject *capi_args,
                           PyObject *capi_keywds,
                           void (*f2py_func)(void)) {
  PyObject * volatile capi_buildvalue = NULL;
...
/******************************* sed_hillslope *******************************/
static char doc_f2py_rout_mod_models_sed_hillslope[] = "\
...
"tipo : input int";
/*  */
static PyObject *f2py_rout_mod_models_sed_hillslope(const PyObject *capi_self,
                           PyObject *capi_args,
                           PyObject *capi_keywds,
...
#endif
  if (!PyArg_ParseTupleAndKeywords(capi_args,capi_keywds,\
    "OOOOOOOO:mod.models.sed_hillslope",\
    capi_kwlist,&alfa_capi,&s2_capi,&v2_capi,&so_capi,&area_sec_capi,&celda_capi,&drena_id_capi,&tipo_capi))
    return NULL;
/*frompyobj*/
  /* Processing variable alfa */
    f2py_success = float_from_pyobj(&alfa,alfa_capi,"mod.models.sed_hillslope() 1st argument (alfa) can't be converted to float");
  if (f2py_success) {
  /* Processing variable celda */
    f2py_success = int_from_pyobj(&celda,celda_capi,"mod.models.sed_hillslope() 6th argument (celda) can't be converted to int");
  if (f2py_success) {
  /* Processing variable tipo */
    f2py_success = int_from_pyobj(&tipo,tipo_capi,"mod.models.sed_hillslope() 8th argument (tipo) can't be converted to int");
  if (f2py_success) {
  /* Processing variable drena_id */
    f2py_success = int_from_pyobj(&drena_id,drena_id_capi,"mod.models.sed_hillslope() 7th argument (drena_id) can't be converted to int");
  if (f2py_success) {
  /* Processing variable s2 */
    f2py_success = float_from_pyobj(&s2,s2_capi,"mod.models.sed_hillslope() 2nd argument (s2) can't be converted to float");
  if (f2py_success) {
  /* Processing variable v2 */
    f2py_success = float_from_pyobj(&v2,v2_capi,"mod.models.sed_hillslope() 3rd argument (v2) can't be converted to float");
  if (f2py_success) {
  /* Processing variable so */
    f2py_success = float_from_pyobj(&so,so_capi,"mod.models.sed_hillslope() 4th argument (so) can't be converted to float");
  if (f2py_success) {
  /* Processing variable area_sec */
    f2py_success = float_from_pyobj(&area_sec,area_sec_capi,"mod.models.sed_hillslope() 5th argument (area_sec) can't be converted to float");
  if (f2py_success) {
/*end of frompyobj*/
#ifdef F2PY_REPORT_ATEXIT
f2py_start_call_clock();
...
/******************************** sed_channel ********************************/
static char doc_f2py_rout_mod_models_sed_channel[] = "\
...
/*  */
static PyObject *f2py_rout_mod_models_sed_channel(const PyObject *capi_self,
                           PyObject *capi_args,
                           PyObject *capi_keywds,
...
#endif
  if (!PyArg_ParseTupleAndKeywords(capi_args,capi_keywds,\
    "OOOOOOO:mod.models.sed_channel",\
    capi_kwlist,&s5_capi,&v5_capi,&q5_capi,&so_capi,&area_sec_capi,&celda_capi,&drena_id_capi))
    return NULL;
/*frompyobj*/
  /* Processing variable celda */
    f2py_success = int_from_pyobj(&celda,celda_capi,"mod.models.sed_channel() 6th argument (celda) can't be converted to int");
  if (f2py_success) {
  /* Processing variable s5 */
    f2py_success = float_from_pyobj(&s5,s5_capi,"mod.models.sed_channel() 1st argument (s5) can't be converted to float");
  if (f2py_success) {
  /* Processing variable q5 */
    f2py_success = float_from_pyobj(&q5,q5_capi,"mod.models.sed_channel() 3rd argument (q5) can't be converted to float");
  if (f2py_success) {
  /* Processing variable drena_id */
    f2py_success = int_from_pyobj(&drena_id,drena_id_capi,"mod.models.sed_channel() 7th argument (drena_id) can't be converted to int");
  if (f2py_success) {
  ...
  if (capi_volsal_tmp == NULL) {
    if (!PyErr_Occurred())
      PyErr_SetString(mod_error,"failed in converting hidden `volsal' of mod.models.sed_channel to C/Fortran array" );
  } else {
    volsal = (float *)(capi_volsal_tmp->data);

  /* Processing variable so */
    f2py_success = float_from_pyobj(&so,so_capi,"mod.models.sed_channel() 4th argument (so) can't be converted to float");
  if (f2py_success) {
  /* Processing variable area_sec */
    f2py_success = float_from_pyobj(&area_sec,area_sec_capi,"mod.models.sed_channel() 5th argument (area_sec) can't be converted to float");
  if (f2py_success) {
  /* Processing variable v5 */
    f2py_success = float_from_pyobj(&v5,v5_capi,"mod.models.sed_channel() 2nd argument (v5) can't be converted to float");
  if (f2py_success) {
/*end of frompyobj*/
#ifdef F2PY_REPORT_ATEXIT
f2py_start_call_clock();
...
/******************************* slide_allocate *******************************/
static char doc_f2py_rout_mod_models_slide_allocate[] = "\
slide_allocate()\n\nWrapper for ``slide_allocate``.\
\n";
/*  */
static PyObject *f2py_rout_mod_models_slide_allocate(const PyObject *capi_self,
                           PyObject *capi_args,
                           PyObject *capi_keywds,
                           void (*f2py_func)(void)) {
  PyObject * volatile capi_buildvalue = NULL;
...
/****************************** slide_ocurrence ******************************/
static char doc_f2py_rout_mod_models_slide_ocurrence[] = "\
...
/*  */
static PyObject *f2py_rout_mod_models_slide_ocurrence(const PyObject *capi_self,
                           PyObject *capi_args,
                           PyObject *capi_keywds,
...
#endif
  if (!PyArg_ParseTupleAndKeywords(capi_args,capi_keywds,\
    "OOO:mod.models.slide_ocurrence",\
    capi_kwlist,&cell_capi,&storaget3_capi,&maxstot3_capi))
    return NULL;
/*frompyobj*/
  /* Processing variable cell */
    f2py_success = int_from_pyobj(&cell,cell_capi,"mod.models.slide_ocurrence() 1st argument (cell) can't be converted to int");
  if (f2py_success) {
  /* Processing variable storaget3 */
    f2py_success = float_from_pyobj(&storaget3,storaget3_capi,"mod.models.slide_ocurrence() 2nd argument (storaget3) can't be converted to float");
  if (f2py_success) {
  /* Processing variable maxstot3 */
    f2py_success = float_from_pyobj(&maxstot3,maxstot3_capi,"mod.models.slide_ocurrence() 3rd argument (maxstot3) can't be converted to float");
  if (f2py_success) {
/*end of frompyobj*/
#ifdef F2PY_REPORT_ATEXIT
f2py_start_call_clock();
...
/***************************** slide_hill2gullie *****************************/
static char doc_f2py_rout_mod_models_slide_hill2gullie[] = "\
slide_hill2gullie(cell)\n\nWrapper for ``slide_hill2gullie``.\
\n\nParameters\n----------\n"
"cell : input int";
/*  */
static PyObject *f2py_rout_mod_models_slide_hill2gullie(const PyObject *capi_self,
                           PyObject *capi_args,
                           PyObject *capi_keywds,
                           void (*f2py_func)(int*)) {
  PyObject * volatile capi_buildvalue = NULL;
...
#endif
  if (!PyArg_ParseTupleAndKeywords(capi_args,capi_keywds,\
    "O:mod.models.slide_hill2gullie",\
    capi_kwlist,&cell_capi))
    return NULL;
/*frompyobj*/
  /* Processing variable cell */
    f2py_success = int_from_pyobj(&cell,cell_capi,"mod.models.slide_hill2gullie() 1st argument (cell) can't be converted to int");
  if (f2py_success) {
/*end of frompyobj*/
#ifdef F2PY_REPORT_ATEXIT
f2py_start_call_clock();
...
static FortranDataDef f2py_models_def[] = {
  ...
  {"shia_v1",-1,{{-1}},0,NULL,(void *)f2py_rout_mod_models_shia_v1,doc_f2py_rout_mod_models_shia_v1},
  {"read_float_basin",-1,{{-1}},0,NULL,(void *)f2py_rout_mod_models_read_float_basin,doc_f2py_rout_mod_models_read_float_basin},
  {"write_float_basin",-1,{{-1}},0,NULL,(void *)f2py_rout_mod_models_write_float_basin,doc_f2py_rout_mod_models_write_float_basin},
  {"rain_pre_mit",-1,{{-1}},0,NULL,(void *)f2py_rout_mod_models_rain_pre_mit,doc_f2py_rout_mod_models_rain_pre_mit},
  {"rain_mit",-1,{{-1}},0,NULL,(void *)f2py_rout_mod_models_rain_mit,doc_f2py_rout_mod_models_rain_mit},
  {"calc_speed",-1,{{-1}},0,NULL,(void *)f2py_rout_mod_models_calc_speed,doc_f2py_rout_mod_models_calc_speed},
  {"sed_allocate",-1,{{-1}},0,NULL,(void *)f2py_rout_mod_models_sed_allocate,doc_f2py_rout_mod_models_sed_allocate},
  {"sed_hillslope",-1,{{-1}},0,NULL,(void *)f2py_rout_mod_models_sed_hillslope,doc_f2py_rout_mod_models_sed_hillslope},
  {"sed_channel",-1,{{-1}},0,NULL,(void *)f2py_rout_mod_models_sed_channel,doc_f2py_rout_mod_models_sed_channel},
  {"slide_allocate",-1,{{-1}},0,NULL,(void *)f2py_rout_mod_models_slide_allocate,doc_f2py_rout_mod_models_slide_allocate},
  {"slide_ocurrence",-1,{{-1}},0,NULL,(void *)f2py_rout_mod_models_slide_ocurrence,doc_f2py_rout_mod_models_slide_ocurrence},
  {"slide_hill2gullie",-1,{{-1}},0,NULL,(void *)f2py_rout_mod_models_slide_hill2gullie,doc_f2py_rout_mod_models_slide_hill2gullie},
  {NULL}
};

static void f2py_setup_models(void (*zmax)(int*,int*,void(*)(char*,int*),int*),void (*h_coef)(int*,int*,void(*)(char*,int*),int*),void (*zmin)(int*,int*,void(*)(char*,int*),int*),void (*prus)(int*,int*,void(*)(char*,int*),int*),void (*hill_long)(int*,int*,void(*)(char*,int*),int*),void (*frictionangle)(int*,int*,void(*)(char*,int*),int*),char *sim_sediments,char *erot,char *rute_storage,void (*max_capilar)(int*,int*,void(*)(char*,int*),int*),void (*elem_area)(int*,int*,void(*)(char*,int*),int*),void (*guarda_cond)(int*,int*,void(*)(char*,int*),int*),void (*vs)(int*,int*,void(*)(char*,int*),int*),void (*h_exp)(int*,int*,void(*)(char*,int*),int*),void (*zcrit)(int*,int*,void(*)(char*,int*),int*),void (*riskvector)(int*,int*,void(*)(char*,int*),int*),void (*slope_stream)(int*,int*,void(*)(char*,int*),int*),void (*voldepo)(int*,int*,void(*)(char*,int*),int*),char *nrows,char *rute_rain,char *dx,char *rute_speed,char *dt,void (*crus)(int*,int*,void(*)(char*,int*),int*),void (*drena)(int*,int*,void(*)(char*,int*),int*),char *xll,char *dep,char *dept,void (*vdc)(int*,int*,void(*)(char*,int*),int*),void (*vsc)(int*,int*,void(*)(char*,int*),int*),void (*slideocurrence)(int*,int*,void(*)(char*,int*),int*),char *ero,void (*control)(int*,int*,void(*)(char*,int*),int*),void (*vd)(int*,int*,void(*)(char*,int*),int*),void (*slope_hill)(int*,int*,void(*)(char*,int*),int*),char *dxp,void (*volero)(int*,int*,void(*)(char*,int*),int*),char *sim_slides,char *speed_type,char *diametro,void (*v_exp)(int*,int*,void(*)(char*,int*),int*),char *sed_factor,void (*parliac)(int*,int*,void(*)(char*,int*),int*),void (*max_gravita)(int*,int*,void(*)(char*,int*),int*),void (*storage)(int*,int*,void(*)(char*,int*),int*),void (*unit_type)(int*,int*,void(*)(char*,int*),int*),void (*mean_rain)(int*,int*,void(*)(char*,int*),int*),void (*krus)(int*,int*,void(*)(char*,int*),int*),void (*zs)(int*,int*,void(*)(char*,int*),int*),char *save_storage,char *gammaw,char *fs,void (*gammas)(int*,int*,void(*)(char*,int*),int*),char *ncols,char *rain_first_point,void (*bo)(int*,int*,void(*)(char*,int*),int*),char *wi,void (*speed_map)(int*,int*,void(*)(char*,int*),int*),char *qskr,char *save_speed,void (*stream_width)(int*,int*,void(*)(char*,int*),int*),void (*stream_long)(int*,int*,void(*)(char*,int*),int*),char *g,char *nceldas,void (*cohesion)(int*,int*,void(*)(char*,int*),int*),void (*v_coef)(int*,int*,void(*)(char*,int*),int*),char *yll,char *nodata,void (*control_h)(int*,int*,void(*)(char*,int*),int*),char *shia_v1,char *read_float_basin,char *write_float_basin,char *rain_pre_mit,char *rain_mit,char *calc_speed,char *sed_allocate,char *sed_hillslope,char *sed_channel,char *slide_allocate,char *slide_ocurrence,char *slide_hill2gullie) {
  int i_f2py=0;
  f2py_models_def[i_f2py++].func = zmax;
  f2py_models_def[i_f2py++].func = h_coef;
  f2py_models_def[i_f2py++].func = zmin;
  f2py_models_def[i_f2py++].func = prus;
  f2py_models_def[i_f2py++].func = hill_long;
  f2py_models_def[i_f2py++].func = frictionangle;
  ...
  f2py_models_def[i_f2py++].func = zcrit;
  f2py_models_def[i_f2py++].func = riskvector;
  f2py_models_def[i_f2py++].func = slope_stream;
  f2py_models_def[i_f2py++].func = voldepo;
  f2py_models_def[i_f2py++].data = nrows;
  f2py_models_def[i_f2py++].data = rute_rain;
  ...
  f2py_models_def[i_f2py++].func = zs;
  f2py_models_def[i_f2py++].data = save_storage;
  f2py_models_def[i_f2py++].data = gammaw;
  f2py_models_def[i_f2py++].data = fs;
  f2py_models_def[i_f2py++].func = gammas;
  f2py_models_def[i_f2py++].data = ncols;
  f2py_models_def[i_f2py++].data = rain_first_point;
  f2py_models_def[i_f2py++].func = bo;
  ...
  f2py_models_def[i_f2py++].func = cohesion;
...
extern void F_FUNC(f2pyinitmodels,F2PYINITMODELS)(void (*)(void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),char*,char*,char*,void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),char*,char*,char*,char*,char*,void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),char*,char*,char*,void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),char*,void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),char*,void (*)(int*,int*,void(*)(char*,int*),int*),char*,char*,char*,void (*)(int*,int*,void(*)(char*,int*),int*),char*,void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),char*,char*,char*,void (*)(int*,int*,void(*)(char*,int*),int*),char*,char*,void (*)(int*,int*,void(*)(char*,int*),int*),char*,void (*)(int*,int*,void(*)(char*,int*),int*),char*,char*,void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),char*,char*,void (*)(int*,int*,void(*)(char*,int*),int*),void (*)(int*,int*,void(*)(char*,int*),int*),char*,char*,void (*)(int*,int*,void(*)(char*,int*),int*),char *,char *,char *,char *,char *,char *,char *,char *,char *,char *,char *,char *));
...
PyMODINIT_FUNC initmod(void) {
  ...
  PyObject *m,*d, *s;
#if PY_VERSION_HEX >= 0x03000000
  m = mod_module = PyModule_Create(&moduledef);
#else
  m = mod_module = Py_InitModule("mod", f2py_module_methods);
#endif
  Py_TYPE(&PyFortran_Type) = &PyType_Type;
  import_array();
  if (PyErr_Occurred())
    {PyErr_SetString(PyExc_ImportError, "can't initialize module mod (failed to import numpy)"); return RETVAL;}
...
#ifdef F2PY_REPORT_ATEXIT
  if (! PyErr_Occurred())
    on_exit(f2py_report_on_exit,(void*)"mod");
#endif
