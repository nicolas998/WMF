...
class HydroSEDPlugin(object):
    ...
    def initGui(self):
        ...
        icon_path = ':/plugins/HydroSEDPlugin/icon.png'
        self.add_action(
            icon_path,
            text=self.tr(u'Hydro-SED'),
            callback=self.run,
